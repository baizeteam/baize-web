    ...
    <div>
      ...
      <div className="container pt-16 md:pt-20 lg:pt-28">
        <div className="mx-auto mb-8 text-center">
          <Link
            href="https://github.com/baizeteam/baize-quick-study"
            target="_blank"
            className="bg-primary hover:bg-primary/90 inline-flex items-center justify-center rounded-md px-6 py-3 text-base font-medium text-white shadow-sm transition-colors duration-200"
          >
            <svg
